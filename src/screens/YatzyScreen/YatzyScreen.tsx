...
export default function YatzyScreen({ navigation }: Props) {
    ...
    return <View style={styles.container}>
        ...
        <NextButton text={"Show winners"} onPress={() => { setTotalVisibility(!totalVisibility);}}/>
        ...
        <PlayersScoreModal GameHelper={gamingHelper} visible={totalVisibility} onExit={() => { setTotalVisibility(false) }} />
    </View>
};