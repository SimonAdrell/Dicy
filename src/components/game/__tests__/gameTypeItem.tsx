...
describe("renders GameTypeItem", () => {
    it("renders GameTypeItem Maxi Yatzy correctly", () => {
      ...
      // Act
      const {getByPlaceholderText, getByText, getAllByText} = render(<GameTypeItem gameName={"Maxi Yatzy"} gameTagLine={"Played with 6 six-sided dice"} 
        IconName={"dice-6"} onSelected={() => {}} />);
